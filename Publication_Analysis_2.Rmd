...
GM_TotalLeaf_AreaMS ~ B3*Maple_TotalLeafArea_EndS + BlackPathDamS +FernS + PCCG_1S+PCCG_2S+ gh_bench2+Transplant_Size_GMS
...
#Direct PC1
OutdirPerfPC1<-permTest_Contrast(fit,c("PCCG_1S"),"PCCG_1S","z",100,Data_Supplement = MapleModel,OutputData = T,Dependent_Variable =c("GM_FecundityMS"))
OutdirPerfPC1 #Didnt work

#Direct PC2
OutdirPerfPC2<-permTest_Contrast(fit,c("PCCG_2S"),"PCCG_2S","z",10000,Data_Supplement = MapleModel,OutputData = T,Dependent_Variable =c("GM_FecundityMS"))

OutdirPerfPC2 #Didnt work. 
...
#Direct PC2
OutdirFecPC2<-permTest_Contrast(fit,c("PCCG_2S"),"PCCG_2S","z",10000,Data_Supplement = MapleModel,OutputData = T,Dependent_Variable =c("GM_FecundityMS"))
