...
#Relative fitness coeficients
dat2$GM_Fecundity2MS<-Standardize(dat2$GM_Fecundity2,meanSTD = T)

fit12<-glmmTMB(GM_Fecundity2MS~treatment+(1|Family)+(1|Row_Field),data=dat2)

summary(fit12)

#Selection differential bolt size
fit12<-glmmTMB(GM_Fecundity2MS~Standardize(PC1BoltSize),data=dat2)
summary(fit12)
