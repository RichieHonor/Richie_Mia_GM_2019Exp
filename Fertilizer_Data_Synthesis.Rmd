...
```{r}
#Removing all but fertilizer treatments. 
...
```{r}
#flavonoid Dataframe.
flav<-flav[grepl("SMITH1-3-80",flav$flav_Tag)|grepl("KVEDG1-8-60",flav$flav_Tag)|grepl("MSMID1-2-0",flav$flav_Tag),]


#Glucosinolate Dataframe.
gluc<-gluc[grepl("SMITH1-3-80",gluc$gluc_Tag)|grepl("KVEDG1-8-60",gluc$gluc_Tag)|grepl("MSMID1-2-0",gluc$gluc_Tag),]

#Chlorophyll Dataframe.
ChlorNoCont<-ChlorNoCont[grepl("SMITH1-3-80",ChlorNoCont$Tag)|grepl("KVEDG1-8-60",ChlorNoCont$Tag)|grepl("MSMID1-2-0",ChlorNoCont$Tag),]
...
FatDat<-FatDat %>% select(Tag,Sample,ID,ChlorA,ChlorB,gluc_Conc,flav_Conc)
