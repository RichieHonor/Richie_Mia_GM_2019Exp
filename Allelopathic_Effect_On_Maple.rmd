...
fit7<-lmer(GM_TotalLeaf_Area ~ Standardize(Maple_TotalLeafArea_End)  + ThripsDam +  
    Standardize(BlackPathDam)  + (1 | Family) + (1 | gh_bench/gh_col) +  
    Standardize(ThripsDam):Standardize(BlackPathDam)+gluc_Conc+Standardize(GM_Leaf_Area),data=MapleModel)
...
fit7<-lmer(GM_TotalLeaf_Area ~ Standardize(Maple_TotalLeafArea_End)  + ThripsDam +  
    Standardize(BlackPathDam)  + (1 | Family) + (1 | gh_bench/gh_col) +  
    Standardize(ThripsDam):Standardize(BlackPathDam)+flav_Conc+Standardize(GM_Leaf_Area),data=MapleModel)
summary(fit7) #no there is not. 
