...
#Removing one of the fitness measurements that was negative. 
#dat$GM_Fecundity[dat$GM_Fecundity==-0.04]<-NA
...
#Trying a pca with all three variables.
#########
pcaGlucCorFlav<-prcomp(~Standardize(ChlorA)+Standardize(gluc_Conc),data=dat2,na.action=na.omit)
biplot(pcaGlucCorFlav)
pcaGlucCorFlav
summary(pcaGlucCorFlav)
pcaGlucCorFlav
