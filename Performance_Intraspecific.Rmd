...
fit7<-lmer(GM_TotalLeaf_Area~BlackPathDam+gluc_Conc+Standardize(GM_Leaf_Area)+(1|Family),data=dat2)
summary(fit7) #Not for glucosinolates

fit7<-lmer(GM_TotalLeaf_Area~BlackPathDam+flav_Conc+Standardize(GM_Leaf_Area)+(1|Family),data=dat2)
