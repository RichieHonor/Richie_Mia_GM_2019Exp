...
#DVGM-20|Q|108 has a germination plate of "b" elsewhere, but it is "a" in this maple file. "b" will be taken as correct as this appears to be consistent will all of the other data files. Therefore, the "a" is changed to a "b" in the final maple dataset here. 
MapDat$Tag[MapDat$Tag=="a|DVGM-20|Q|108"]<-"b|DVGM-20|Q|108"
