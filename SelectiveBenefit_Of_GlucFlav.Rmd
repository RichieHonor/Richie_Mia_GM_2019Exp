...
for(i in 1:100){
  ...
  #Run Model with randomized glucConc and extract p-value
  flavPval<-summary(glmer(BlackPathDam~flav_Conc+(1|Family/Tag),family=poisson,data=datPerTest))$coef[2,4]
...
for(i in 1:100){
  ...
  #Run Model with randomized glucConc and extract p-value
  flavPval<-summary(glmer(ThripsDam~flav_Conc+(1|Family/Tag),family=poisson,data=datPerTest))$coef[2,4]
...
#About half of those with thrips dam is also significant. I need either a different model, or to use a logistic regression. 
