...
flavyA<-flavSlope(flavplot, -2.93618)
flavyGM<-flavSlope(flavplot, -2.93618+ 0.25862)
flavyM<-flavSlope(flavplot, -2.93618-0.44161)
...
flavyA<-flavSlope(flavplot, -2.93618+1,log = T)
flavyGM<-flavSlope(flavplot, -2.93618+0.25862+1,log = T)
flavyM<-flavSlope(flavplot, -2.93618-0.44161+1,log = T)
