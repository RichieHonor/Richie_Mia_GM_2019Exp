...
fit<-glmmTMB(BlackPathDam~treatment+flav_Conc+GM_Leaf_Area+ChlorA+(1|Family/Tag),family=nbinom2,data=dat)
summary(fit)
...
flavyA<-flavSlope(flavplot, 0.4957)
flavyGM<-flavSlope(flavplot, 0.4957+0.2537)
flavyM<-flavSlope(flavplot, 0.4957-0.4026)


tiff("Defence_Figures/FlavonoidBlackPathogen.tiff", units="in", width=8, height=6, res=300)
