...
theme_simple_vertScientific<-function(){
  #base theme
  theme_classic() %+replace%
    #theme additions
    theme(
      ...
      legend.text = element_text(color = "black", size = 14, face = "bold.italic"),
      legend.background=element_rect(size=0.5,colour="black"),
      #Theme of axis text and ticks
      axis.text.x = element_text(color = "black", size = 14, face = "bold"),
      axis.text.y = element_text(color = "black", size = 14, face = "bold.italic"),
