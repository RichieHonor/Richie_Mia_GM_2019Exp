...
ggplot(Final)+
  geom_jitter(aes(x=treatment,y=gluc_Conc,colour=Fert))


#---
#Flavonoid
ggplot(Final)+
  geom_jitter(aes(x=treatment,y=flav_Conc,colour=Fert))


#---
#ChlorA
ggplot(Final)+
  geom_jitter(aes(x=treatment,y=ChlorA,colour=Fert))
